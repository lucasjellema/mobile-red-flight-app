  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="retrieveFlightDetails_params"
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED FEB 25 15:57:02 CET 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:getFlightDetailsRequest>
      <tns:FlightCode>
        <com:CarrierCode>
          <xsl:value-of select="substring (/ns0:retrieveFlightDetails_params/ns0:flightCode, 1,2)"/>
        </com:CarrierCode>
        <com:FlightNumber>
          <xsl:value-of select="substring (/ns0:retrieveFlightDetails_params/ns0:flightCode, 3 )"/>
        </com:FlightNumber>
      </tns:FlightCode>
      <tns:FlightDate>
        <xsl:value-of select="/ns0:retrieveFlightDetails_params/ns0:flightDate"/>
      </tns:FlightDate>
    </tns:getFlightDetailsRequest>
  </xsl:template>
</xsl:stylesheet>
